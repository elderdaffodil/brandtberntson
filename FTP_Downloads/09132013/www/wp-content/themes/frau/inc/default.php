...
$lz_default['elements']=array(
	'logo'=>array('title'=>__( 'Logo', 'lizard' ), 'show'=>true, 'help'=>'logo', 'edit'=>'admin.php?page=general'),
	...
	'slider'=>array('title'=>__( 'Slider', 'lizard' ), 'show'=>true, 'help'=>'slider', 'edit'=>'admin.php?page=slider'),
	'showroom'=>array('title'=>__( 'Showroom', 'lizard' ), 'show'=>true, 'help'=>'showroom', 'edit'=>'admin.php?page=showroom'),
