<?php global $settings; ?>
<?php if ( ($settings['elements']['showroom']['show'] || is_super_admin())&&(is_home()||$settings['showroom']['srinnerpages']) ) { ?>
...
<?php while ( $items->have_posts() ) : $items->the_post(); ?>
			...
			<div class='item'>
				...
				<?php if ($settings['showroom']['length'] > 0) frau_custom_excerpt('echo=true&maxchar='.$settings['showroom']['length']); ?>
