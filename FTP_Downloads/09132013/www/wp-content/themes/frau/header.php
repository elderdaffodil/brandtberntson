...
'container'       => 'div',
	...
	'fallback_cb'=>'frau_theme_secondary_menu'
	) ); ?>
		</div>
		<?php } ?>
		<?php if ( $settings['elements']['search']['show'] || is_super_admin() ) { ?>
		<div class="hd-left lzblock" <?php if (!$settings['elements']['search']['show']&&is_super_admin()) echo 'style="display:none"'; ?> data-block="search">
		<?php get_search_form(); ?>
		</div>
		<?php } ?>
		<div class="clear"></div>
		...
		<?php wp_nav_menu( array( 'theme_location' => 'header-menu1',
			...
			'fallback_cb'=>'frau_theme_main_menu'
		) ); ?>
		</div>
		<?php } ?>
		<div class="clear"></div>
		<?php if ( ($settings['elements']['slider']['show'] || is_super_admin())&&(is_home()||$settings['slider']['innerpages']) ) { ?>
