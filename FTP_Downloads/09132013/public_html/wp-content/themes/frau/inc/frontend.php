...
function frau_admin_bar_render() {
...
add_action( 'wp_before_admin_bar_render', 'frau_admin_bar_render' );
add_action( 'wp_footer', 'frau_frontend_footer'); 

function frau_customization() {  
	global $settings; ?>
	<style>
...
add_action('wp_head', 'frau_customization');
